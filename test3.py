        ...
        if not pdf_file or not excel_file or not token or not resource_id:
            ...
            try:
                with st.spinner("Processing..."):
                    ...
                    start_dt = nairobi_tz.localize(datetime.combine(selected_date, datetime.min.time())) + timedelta(hours=start_hour)
                    end_dt = nairobi_tz.localize(datetime.combine(selected_date, datetime.min.time())) + timedelta(hours=end_hour)
